...
export const desktopApps: DesktopApp[] = [
  { id: 'my-computer', label: 'My Computer', title: 'My Computer', icon: '/desktop-icons/my-computer.svg', x: 72, y: 64, width: 460, height: 300 },
  { id: 'resume', label: 'Resume', title: 'Resume', icon: '/desktop-icons/resume.svg', x: 116, y: 96, width: 520, height: 560 },
