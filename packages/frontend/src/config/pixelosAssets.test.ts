...
describe('pixelosAssets', () => {
  it('preserves the exact owner-supplied PixelOS raster asset contract and approved local desk additions', () => {
    ...
    expect(Object.values(PIXEL_OS_ASSETS)).toEqual([
      ...
      '/pixelos/portraits/pixelos-leonardo-entry-hero-smart-blink-128.gif',
      '/pixelos/portraits/pixelos-leonardo-entry-hero-static-128.png',
      '/pixelos/icons/signal/pixelos-signal-tool-projects-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-resume-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-about-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-wink-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-attention-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-send-00.png',
      '/pixelos/icons/signal/pixelos-signal-tool-open-app-00.png',
